...
--  global paths  --
--------------------
--custom= hs.fs.pathToAbsolute(cfg.global.paths.base .. '/.hammerspoon/private/weather_api_url.lua')
cfg.global.paths = {}
cfg.global.paths.base  = os.getenv('HOME')
cfg.global.paths.tmp   = hs.fs.pathToAbsolute(cfg.global.paths.base .. '/tmp')
cfg.global.paths.hs    = hs.fs.pathToAbsolute(cfg.global.paths.base .. '/.hammerspoon')

--print("aaaabbbbbbbb")
--print("bccccccccc")
--print(cfg.global.paths.tmp)
--print("ddddddd")
